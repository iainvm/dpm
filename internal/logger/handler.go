...
func NewHandler(handlerOptions *slog.HandlerOptions, options ...Option) *Handler {
...
func NewDefault(opts *slog.HandlerOptions) *Handler {
	return NewHandler(opts, WithDestinationWriter(os.Stdout), WithColor(), WithOutputEmptyAttrs())
}
